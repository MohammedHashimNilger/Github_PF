...
const Favorites = () => {
  ...
  const handleDelete = (id) => {
    const upadatedFav = fav.filter((repo) => repo.id !== id);
            ...
            {fav.map((favs) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-xl font-bold">{favs.name}</h2>
                    <p className="text-gray-400">{favs.login}</p>
                  </div>
                </div>
